...
export default function Meal() {
  ...
  const [text, setText] = useState("Thêm mới thực phẩm");
    ...
    if (product.description) {
      ...
      if (product.meal_id !== "0") {
        ...
        toast.current.show({
          severity: "success",
          summary: "Thành công",
          detail: `Cập nhật thực phẩm ${product.meal_name} thành công`,
          life: 3000,
        });
        setText("Chỉnh sửa thực phẩm");
      } else {
        ...
        toast.current.show({
          severity: "success",
          summary: "Thành công",
          detail: "Tạo  mới thực phẩm thành công",
          life: 3000,
        });
        setProductDialog(false);
      }
  ...
  const header = (
    <div className="flex flex-wrap gap-2 align-items-center justify-content-between">
      <h4 className="m-0 mb-4">Quản lý thực phẩm</h4>
      ...
      <div>
        ...
        <div className="card">
          ...
          <DataTable
            ...
            currentPageReportTemplate="Đang hiển thị {first} đến {last} trong tổng số {totalRecords} thực phẩm"
            header={header}
          >
            <Column
              field="meal_id"
        ...
        >
          <div className="confirmation-content">
            ...
            {product && (
              <span>
                Bạn có chắc chắn muốn xóa thực phẩm <b>{product.meal_name}</b>?
              </span>
            )}
          </div>
        </Dialog>
