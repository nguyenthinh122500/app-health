...
const { suggestWorkout, getListWorkout, getListWorkoutByCategory, getWorkoutByID, createWorkout, updateWorkout, deletePlanMeal, deletePlanExercises, deleteWorkout, searchWorkoutByName, createPlanDaily, deletePlanDaily } = require('../controllers/workout');
